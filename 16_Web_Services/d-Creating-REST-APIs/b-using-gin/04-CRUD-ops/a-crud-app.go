...
func main() {
	...
	// GET - Get a specific grocery by ID
	...
	// POST Method - Create a record . Write operation
	// Add a new grocery
	r.POST("/groceries", func(c *gin.Context) {
		var newGroceryItem Grocery
		if err := c.ShouldBindJSON(&newGroceryItem); err != nil {
			c.JSON(400, gin.H{"error": "Invalid input"})
			return
		}
		groceries = append(groceries, newGroceryItem)
...
//     update a specific field, in the record
